...
//                 if (timeouts[sala]) clearTimeout(timeouts[sala]);

//                 // Cria um timeout para destruir a sala se ninguém entrar
//                 timeouts[sala] = setTimeout(() => {
//                     removerSala(sala);
//                     console.log(`🔴 Sala ${sala} destruída por inatividade`);
//                 }, 20000);
